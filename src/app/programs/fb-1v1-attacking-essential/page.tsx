...
export const metadata: Metadata = {
  title: "Essential 1v1 Attacking Full-back Course - REBALL",
  ...
  keywords: "REBALL, full-back training, 1v1 attacking, crossing course, football training, full-back development",
};

export default function EssentialFB1v1AttackingCourse() {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master the essential skills every full-back needs for 1v1 attacking
              </p>
            </div>
