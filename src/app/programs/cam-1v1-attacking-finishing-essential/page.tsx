...
export const metadata: Metadata = {
  title: "Essential 1v1 Attacking CAM Finishing Course - REBALL",
  ...
  keywords: "REBALL, CAM training, 1v1 attacking, finishing course, football training, CAM development",
};

export default function EssentialCAM1v1AttackingFinishingCourse() {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master the essential skills every CAM needs for 1v1 attacking and finishing
              </p>
            </div>
