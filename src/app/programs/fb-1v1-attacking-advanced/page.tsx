...
import { Target, Users, Trophy, Star, CheckCircle, Clock, Play, BookOpen, Award, Zap, Lock } from "lucide-react";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Advanced 1v1 Attacking Full-back Course - REBALL",
  description: "Learn the specific advanced tactical, movement and technical information you need to become unstoppable in beating defenders and delivering assists.",
  keywords: "REBALL, full-back training, 1v1 attacking, advanced crossing course, football training, full-back development",
};

export default function AdvancedFB1v1AttackingCourse() {
  return (
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-black dark:to-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200 rounded-full text-sm font-semibold mb-4 flex items-center gap-1 justify-center">
            ...
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-200 mb-8 leading-relaxed">
              Learn the specific advanced tactical, movement and technical information you need to become unstoppable in beating defenders and delivering assists
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  <p>
                    Learn the specific advanced tactical, movement and technical information you need to become unstoppable in beating defenders and delivering assists. This course features the exact 8 1v1 attacking scenarios you face in the game where you&apos;ll learn advanced information for how to consistently beat defenders on the inside and outside and execute perfect crosses for assists.
                  </p>
                  <p>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Position: Full-back</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Award className="w-5 h-5 text-orange-500" />
                    <span className="text-gray-700 dark:text-gray-300">Prerequisites: Essential Course Recommended</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master the advanced skills to become an unstoppable attacking full-back
              </p>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                      Become unstoppable in beating defenders on the inside and outside
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300">
                      Master advanced techniques to consistently beat any defender in both directions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Advanced tactical awareness to read and exploit any defensive weakness.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Advanced crossing techniques for maximum assist potential.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Advanced spatial awareness to identify and exploit early delivery opportunities.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Advanced solutions when defenders successfully prevent early crossing.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join this advanced course and elevate your attacking game to the next level.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
