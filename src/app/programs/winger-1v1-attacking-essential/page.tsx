...
export const metadata: Metadata = {
  title: "Essential 1v1 Attacking Winger Crossing Course - REBALL",
  ...
  keywords: "REBALL, winger training, 1v1 attacking, crossing course, football training, winger development",
};

export default function EssentialWinger1v1AttackingCourse() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-200 mb-8 leading-relaxed">
              Learn the specific essential tactical, movement and technical information you need to instantly get more assists in the exact 8 1v1 scenarios you face in the game
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  <p>
                    This essential course is designed specifically for wingers who want to improve their 1v1 attacking abilities and crossing in the final third. You&apos;ll learn the fundamental principles that separate good wingers from great ones.
                  </p>
                  <p>
                    Through detailed analysis of the 8 most common 1v1 scenarios wingers face in games, you&apos;ll develop the tactical awareness, movement patterns, and technical skills needed to consistently create and deliver quality crosses.
                  </p>
                  <p>
                    Perfect for players looking to build a solid foundation in 1v1 attacking play and crossing before progressing to our advanced courses.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Position: Wingers</span>
                  </div>
                  <div className="flex items-center gap-3">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master the essential skills every winger needs for 1v1 situations and crossing
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Understand when and how to engage in 1v1 situations, reading defender positioning and creating space for crosses.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Learn essential movement techniques to create separation from defenders and position yourself for optimal crossing.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Master the fundamental crossing techniques needed to deliver quality balls into the box consistently.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Study the 8 most common 1v1 scenarios wingers face and learn the optimal approach for each situation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Develop quick decision-making skills to choose the right crossing option based on the specific 1v1 scenario.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Comprehensive coverage of all essential 1v1 attacking and crossing scenarios
              </p>
            </div>

            <div className="space-y-4">
              {[
                "Module 1: Introduction to 1v1 Attacking Principles for Wingers",
                "Module 2: Creating Space and Separation on the Flank",
                "Module 3: Essential Crossing Techniques",
                "Module 4: Crossing from Different Positions", 
                "Module 5: One-Touch Crossing and Quick Delivery",
                "Module 6: Crossing Under Pressure",
                "Module 7: Reading Defenders and Timing Crosses",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Improve Your Crossing?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Join this essential course and start creating more assists in 1v1 situations today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
