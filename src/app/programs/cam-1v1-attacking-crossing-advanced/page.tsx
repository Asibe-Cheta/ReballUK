...
export const metadata: Metadata = {
  title: "Advanced 1v1 Attacking CAM Crossing Course - REBALL",
  ...
  keywords: "REBALL, CAM training, advanced 1v1 attacking, crossing course, football training",
};

export default function AdvancedCAM1v1AttackingCrossingCourse() {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master advanced skills to become an unstoppable attacking CAM
              </p>
            </div>
