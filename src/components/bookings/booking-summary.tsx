...
const positionDetails = {
  ...
  CM: { color: "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400" },
  CDM: { color: "bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-400" },
  FULLBACK: { color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400" },
  CENTREBACK: { color: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400" },
